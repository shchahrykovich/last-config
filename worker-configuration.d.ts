/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a0ea94611a844a2755d75de4e3c29b89)
// Runtime types generated with workerd@1.20251128.0 2025-05-05 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./.open-next/worker");
	}
	interface Env {
		GITHUB_URL: "https://github.com/shchahrykovich/last-config";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_URL" | "ALLOW_TO_CREATE_MORE_THAN_ONE_TENANT" | "NEXTJS_ENV" | "AUTH_SECRET">> {}
}
